...
typedef GPB_ENUM(TKMMeaning_Type) {
  ...
  TKMMeaning_Type_Primary = 0,
  TKMMeaning_Type_Secondary = 1,

  /** Old meaning for a radical that was changed. */
  TKMMeaning_Type_AuxiliaryWhitelist = 2,

  /** Similar (within edit distance) to an accepted reading but incorrect. */
  TKMMeaning_Type_Blacklist = 3,
};
...
typedef GPB_ENUM(TKMReading_Type) {
  ...
  TKMReading_Type_Onyomi = 0,
  TKMReading_Type_Kunyomi = 1,
  TKMReading_Type_Nanori = 2,
};
...
typedef GPB_ENUM(TKMVocabulary_PartOfSpeech) {
  ...
  TKMVocabulary_PartOfSpeech_Noun = 0,
  TKMVocabulary_PartOfSpeech_Numeral = 1,
  TKMVocabulary_PartOfSpeech_IntransitiveVerb = 2,
  TKMVocabulary_PartOfSpeech_IchidanVerb = 3,
  TKMVocabulary_PartOfSpeech_TransitiveVerb = 4,
  TKMVocabulary_PartOfSpeech_NoAdjective = 5,
  TKMVocabulary_PartOfSpeech_GodanVerb = 6,
  TKMVocabulary_PartOfSpeech_NaAdjective = 7,
  TKMVocabulary_PartOfSpeech_IAdjective = 8,
  TKMVocabulary_PartOfSpeech_Suffix = 9,
  TKMVocabulary_PartOfSpeech_Adverb = 10,
  TKMVocabulary_PartOfSpeech_SuruVerb = 11,
  TKMVocabulary_PartOfSpeech_Prefix = 12,
  TKMVocabulary_PartOfSpeech_ProperNoun = 13,
  TKMVocabulary_PartOfSpeech_Expression = 14,
  TKMVocabulary_PartOfSpeech_Adjective = 15,
  TKMVocabulary_PartOfSpeech_Interjection = 16,
  TKMVocabulary_PartOfSpeech_Counter = 17,
  TKMVocabulary_PartOfSpeech_Pronoun = 18,
  TKMVocabulary_PartOfSpeech_Conjunction = 19,
};
...
typedef GPB_ENUM(TKMSRSStage_Category) {
  /**
   * Value used if any message's field encounters a value that is not defined
   * by this enum. The message will also have C functions to get/set the rawValue
   * of the field.
 ...
 * the time this source was generated.
 **/
BOOL TKMSRSStage_Category_IsValidValue(int32_t value);
...
typedef GPB_ENUM(TKMFormattedText_Format) {
  ...
  TKMFormattedText_Format_Radical = 0,
  TKMFormattedText_Format_Kanji = 1,
  TKMFormattedText_Format_Japanese = 2,
  TKMFormattedText_Format_Reading = 3,
  TKMFormattedText_Format_Vocabulary = 4,
  TKMFormattedText_Format_Italic = 5,
  TKMFormattedText_Format_Bold = 6,
  TKMFormattedText_Format_Link = 7,
};
