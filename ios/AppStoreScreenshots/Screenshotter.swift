...
import Foundation
  ...
  class FakeLocalCachingClient: LocalCachingClient {
    ...
    override func getStudyMaterial(id _: Int32) -> TKMStudyMaterials? {
      nil
    }
    ...
    override func getAssignment(id _: Int32) -> TKMAssignment? {
      nil
    }
    ...
    override func getSRSLevelCount(at category: TKMSRSStageCategory) -> Int32 {
      switch category {
