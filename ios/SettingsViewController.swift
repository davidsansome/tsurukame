...
@objcMembers class SettingsViewController: UITableViewController {
  ...
  func interfaceStyleValueText() -> String {
    ...
    case InterfaceStyle.system:
      return "System"
    case InterfaceStyle.light:
      return "Light"
    case InterfaceStyle.dark:
      return "Dark"
    }
  }
  ...
  func lessonItemOrderValueText() -> String {
    ...
    for i in Settings.lessonOrder {
      ...
      lessonItemOrderText.append(TKMSubject_Type(rawValue: i)!.name())
    }
  ...
  func reviewOrderValueText() -> String {
    ...
    case ReviewOrder.random:
      return "Random"
    case ReviewOrder.ascendingSRSStage:
      return "Ascending SRS stage"
    case ReviewOrder.descendingSRSStage:
      return "Descending SRS stage"
    case ReviewOrder.currentLevelFirst:
      return "Current level first"
    case ReviewOrder.lowestLevelFirst:
      return "Lowest level first"
    case ReviewOrder.newestAvailableFirst:
